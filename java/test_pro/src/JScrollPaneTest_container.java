...
import javax.swing.WindowConstants;
	 ...
	 *
	 */
	public class JScrollPaneTest_container extends JFrame{
	//导入包的快捷键 shift+ctrl+o
	    public JScrollPaneTest_container(){//定义一个构造方法
	        Container container=getContentPane();//创建一个容器
	        Container con=getContentPane();//创建一个容器
	        //创建文本区域组件
	    ...
	    public static void main(String[] args) {
	    	...
	    	JScrollPaneTest_container jp=new JScrollPaneTest_container();
	    	jp.setVisible(true);
	    }
