...
public abstract class AbstractDecoder {
	...
	private final Mp3ToWav mp3ToWav;
	 ...
	 */
	public AbstractDecoder(IAudio audio, Mp3ToWav mp3ToWav) {
	...
	protected final String openDecoder() {
		...
		case 1:
			layer = new Layer1(header, audio, mp3ToWav);
			break;
		case 2:
			layer = new Layer2(header, audio, mp3ToWav);
			break;
		case 3:
			layer = new Layer3(header, audio, mp3ToWav);
			break;
		default:
			eof = true;
		}
