...
public final class Layer3 extends AbstractLayer {
	 ...
	 */
	public Layer3(Header h, IAudio audio, Mp3ToWav mp3ToWav) {
		this(h, audio, mp3ToWav, true);
	}
	 ...
	 */
	public Layer3(Header h, IAudio audio, Mp3ToWav mp3ToWav, boolean coresEnabled) {
		super(h, audio, mp3ToWav);
		header = h;
